// Конкурентний діалог з публікацією англійською
  ...
  return (
    <>
      <div className={styles.container}>
        <h1>Конкурентний діалог з публікацією англійською </h1>
        <Formik
          initialValues={{ }}
...
export default CompetitiveDialogEn;
