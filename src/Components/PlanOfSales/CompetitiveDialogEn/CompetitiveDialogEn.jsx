// Конкурентний діалог з публікацією англійською мовою
...
import styles from './CompetitiveDialogEn.scss';
  ...
  return (
    <>
      <div className={styles.container}>
        <h1>Конкурентний діалог з публікацією англійською мовою</h1>
        <Formik
          initialValues={{ }}
                ...
                <div className={styles.containerSupplyProposition}>
                  ...
                  <div className={styles.supplyProposition}>
                    <div className={styles.labesSupply}>
                      {/* eslint-disable */}
                        <label>
                            <Field type="radio" name="picked1" value="One" checked/>
        ...
        <b>Конкурентний діалог з публікацією англійською мовою</b>
      </div>
    </>
  );
};
