# Generated by Django 3.0.7 on 2020-07-29 10:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=head.utils.custom_upload_to, verbose_name='vnm_image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to=head.utils.custom_upload_to, verbose_name='vnm_case_images')),
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_case_images', to='head.Blog', verbose_name='vnm_case_blog')),
            ],
            options={
                'verbose_name': 'vn_blog_case_images',
                'verbose_name_plural': 'vnp_blog_case_images',
            },
            bases=(parler.models.TranslatableModelMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to=head.utils.custom_upload_to, verbose_name='vnm_projectimage_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to=head.utils.custom_upload_to, verbose_name='vnm_projectimage_slider')),
        ...
        migrations.CreateModel(
            name='BlogCaseImagesTranslation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('name', models.CharField(max_length=100, verbose_name='vnm_blog_case_name')),
                ('description', models.CharField(max_length=256, verbose_name='vnm_blog_case_desc')),
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='head.BlogCaseImages')),
            ],
            options={
                'verbose_name': 'vn_blog_case_images Translation',
                'db_table': 'head_blogcaseimages_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master')},
