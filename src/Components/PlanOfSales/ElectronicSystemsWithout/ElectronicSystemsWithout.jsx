...
import styles from './ElectronicSystemsWithout.scss';

const ElectronicSystemsWithout = () => {
  ...
  return (
    <>
      <div className={styles.container}>
        <h1>Закупівля без використання електронної системи</h1>
        <Formik
          initialValues={{ }}
...
export default ElectronicSystemsWithout;
